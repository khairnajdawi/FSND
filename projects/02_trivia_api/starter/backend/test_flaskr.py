...
class TriviaTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.database_path = "postgresql://{}:{}@{}/{}".format(self.database_user,self.database_user_pass,'localhost:5432', self.database_name)
    ...
    #test get all questions, should return http code 200,success with questions list and total questions count. 
